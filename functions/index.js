...
exports.notifyOnRegister = functions.https.onCall(async (data, context) => {
  const {parentEmail, parentName} = data;

  const mailOptions = {
    from: "kelli.b.then@gmail.com",
    to: "kelli.b.then@gmail.com",
    subject: "A new user has registered for KBT Reading Support",
    html: `
